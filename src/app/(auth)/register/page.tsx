  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950">
      <div className="bg-gray-900 p-8 rounded-2xl w-full max-w-md border border-gray-800">
        ...
        <p className="text-gray-400 mb-8 text-sm">Criar conta</p>
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div>
            ...
            <input type="password" value={password} onChange={e => setPassword(e.target.value)}
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-purple-500" required minLength={6} />
          </div>
        ...
        <p className="text-center text-gray-500 text-sm mt-6">
          Já tem conta? <a href="/login" className="text-purple-400 hover:underline">Entrar</a>
        </p>
      </div>
    </div>
  )
